...
impl Processor {
    ...
    fn process_init_escrow(
        ...
        escrow_info.unlock_time = _slot;
        escrow_info.timeout_time = timeout_time;
    ...
    fn process_exchange(
        ...
        let slot_greater_than_unlock_time = if _slot > escrow_info.unlock_time {true} else {false};
        let slot_lesser_than_timeout_time = if _slot < escrow_info.timeout_time {true} else {false};
    ...
    fn process_reset_timelock(accounts: &[AccountInfo], program_id: &Pubkey) -> ProgramResult {
        ...
        msg!("Resetting unlock_time and timeout_time...");
